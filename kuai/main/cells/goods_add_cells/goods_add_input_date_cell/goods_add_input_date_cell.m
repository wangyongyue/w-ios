...
@interface goods_add_input_date_cell ()
...
@implementation goods_add_input_date_cell
...
- (void)loadModel:(id)model{
    ...
    goods_add_input_date *m = (goods_add_input_date *)model;
    ...
    [self.field editBegin:^{
        ...
        [AlertDate show:m.input block:^(NSString *text) {
            m.input = text;
...
@end
@implementation goods_add_input_date
- (NSString *)identifier{ return NSStringFromClass([goods_add_input_date_cell class]);}
- (NSValue *)size{
...
+ (goods_add_input_date *)creat:(NSString *)title placeholder:(NSString *)placeholder input:(NSString *)input{
    ...
    goods_add_input_date *test = [[goods_add_input_date alloc]init];
    test.title = title;
