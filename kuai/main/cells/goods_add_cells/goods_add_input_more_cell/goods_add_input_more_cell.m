...
@interface goods_add_input_more_cell ()
...
@implementation goods_add_input_more_cell
...
- (void)loadModel:(id)model{
    ...
    goods_add_input_more *m = (goods_add_input_more *)model;
...
@end
@implementation goods_add_input_more
- (NSString *)identifier{ return NSStringFromClass([goods_add_input_more_cell class]);}
- (NSValue *)size{
    return [NSValue valueWithCGSize:CGSizeMake(1, 50)];
}
+ (goods_add_input_more *)creat:(NSString *)title placeholder:(NSString *)placeholder input:(NSString *)input{
    
    goods_add_input_more *test = [[goods_add_input_more alloc]init];
    test.title = title;
